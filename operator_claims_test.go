...
func Test_SystemAccount(t *testing.T) {
	...
	var asuTests = []struct {
		...
		{"", false},
		{"x", true},
		{"a0399edf03091a600d19871ace3d52e1b7b6826e63a8cfc70bd341ffeb5f806c8394ed1", false},
...
func Test_ForwardCompatibility(t *testing.T) {
	newOp := `eyJ0eXAiOiJqd3QiLCJhbGciOiJzZWNwMjU2azEtbmtleSJ9..gptGdQwGgW4-zmn9omG_yTM4HHDjGXKanX_JBUZAguM1exBxutIrlgFp2AZUu5HfIocQS1z5D-_4Egxgm_7EhA`
